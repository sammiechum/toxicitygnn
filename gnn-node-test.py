...
datasetName = 'dataset_partial'
datasetName2 = 'dataset_test'
...
with open('data/%s.pkl' % datasetName2, 'rb') as f:
    records2 = pickle.load(f)
...
validMolecules, batchListV = convertMolRecordsToData([records2['mols'][i] for i in records2['splits'][split]['valid']])
